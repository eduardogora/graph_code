          ...
          ? (
            ...
            <div>
                ...
                <Card style={{margin: "100px 50px 50px 50px"}}>
                    <Card.Grid className="Titulo1" style={{width: "50%", display:"flex", alignItems: 'center', flexDirection:"column", justifyContent:"center"}}>{CurrentInfo.Info[0]}</Card.Grid>
                ...
                <Card style={{margin: "50px"}}>
                    ...
                    <Card.Grid className="Titulo1" style={{width: "50%", display:"flex", alignItems: 'center', flexDirection:"column", justifyContent:"center"}}>{CurrentInfo.Info[1]}</Card.Grid>
                </Card>
                ...
                <Card style={{margin: "50px"}}>
                    ...
                    <Card.Grid className="Titulo1" style={{width: "50%", display:"flex", alignItems: 'center', flexDirection:"column", justifyContent:"center"}}>{CurrentInfo.Info[2]}</Card.Grid>
                </Card>
